...
export default withAuth(
    function middleware(request: NextRequest) {
        ...
        const cspDirectives = [
            ...
            "connect-src 'self' https://api.github.com https://accounts.google.com https://*.googleapis.com https://*.ingest.sentry.io https://*.ingest.de.sentry.io https://*.google-analytics.com https://vercel.live",
